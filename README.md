...
My philosophy can be best described as user-centric, team-oriented, people-first, and solution-driven, fostering a collaborative and efficient development environment.
...
**Performance optimization**, Scalability, WebSockets, **Lazy loading** (components & data), Real-Time data updates, **Progressive enhancement**, **Code splitting**, Modular development, **REST**, CICD (Continuous Integration/Continuous Deployment), **GitFlow**, **BEM** (Block Element Modifier), **CSS preprocessors** (SASS, LESS), 7-1 SCSS, Web scraping
...
- Collaborate: **GitHub**, **GitLens**, GitGraph, Jira, **Azure DevOps**, **Notion**
...
- Other: **SCSS**, LESS, **TanStack Router** (React router), **Lodash**, **Video.js**, jQuery

## Recent projects

_Please note: The outlined projects are subject to various Non-Disclosure NDAs, which restrict the level of detail I am disclosing in this format. Project preceding those listed are omitted for brevity's sake._
...
### Graphing Library
  - Identified critical deficiencies in the proposed solution with clear reccomendations on how to proceed instead
  - Using the user-centric approach, envisioned and produced a domain-specific functionality set not found in any of the competing solutions
  - Led the development of the proposed solution resulting in six to ten thousand USD per month saved for a client  
...
- Devised a multi-phased approach to tackle critical deficiencies, balancing between refactoring and new futures being developed
- With a clear timeline in mind, prioritized the tasks for each team member in order to achieve clarity on both their role in the process, its steps and the overall goal
...
- Proposed a powerful set of visualizations as a crucial part of UI, distilling extensive data sets into simple yet interactive visuals
...
I have held various roles in the development process **lead developer**, **sole developer/designer**, **senior member of clients' development teams**. Throughout my tenure, I have collaborated with **multiple contractors** on diverse projects, most often **big data** and **machine learning** SaaS. These initiatives have encompassed some less common concepts — **real-time and near real time data management**, **selective data persistence**, **charting**, **mathematical graphs**, **audio management and visualization** and more. Leveraging my expertise in **ReactJS, TypeScript, Redux, RTK, MUI, JointJS, ECharts**, and other technologies, I have been instrumental in both maintaining existing SPAs and spearheading the development of new ones.
...
I **transitioned into the role of a full-stack developer**, and within the first year, **assumed the position of the lead developer's right hand**, eventually replacing him (based on his recommendation upon departure). My responsibilities encompassed the full range of the fullstack developer responsibilities. From designing the UI to optimizing database performance on a project developed for an insurance company. The stack consisted of:  AngularJS (styled with **Bootstrap**), **ASP.NET (C#)** (augmented with **Entity Framework**), and a **Microsoft SQL Server** database.

The result was the **expansion of contracting company business from Croatian to the Italian market, with the Italian partner selecting me as the primary point of contact**.

The result was **development team size reduced by 40%** despite the application handling **three times the volume of data**, which allowed for the redistribution of human resources.
...
Using the above approach we pioneered several new ideas, including **real-time positioning**, an incident reporting system with **push notifications**, and a true **offline mode**, setting new standards for next projects and **reducing development time and costs by over 70%** when compared to company previous practices. 
...
Solely produced a **native Android application** focused around merging **real-time video data with GPS coordinates and user input** based on the iOS version fo it.
...
Through this experience, I **honed my soft skills**, especially the **ability to communicate complex concepts in a clear and accessible manner**, fostering an environment conducive to learning and growth. I also **improved general problem-solving skills**, as I often encountered unique challenges in various domains.

While I initially considered establishing my own company and already conducted the initial talks with several other tutors I have personally known, I ultimately decided to pivot towards being more involved in the industry before doing so.
